def guidstringfromhex(hex_str):
	if len(hex_str) != 32:
		raise ValueError("GUID hex string must be exactly 32 characters long")

	# Convert first three fields (Little Endian)
	data1 = hex_str[6:8] + hex_str[4:6] + hex_str[2:4] + hex_str[0:2]  # 4 bytes
	data2 = hex_str[10:12] + hex_str[8:10]  # 2 bytes
	data3 = hex_str[14:16] + hex_str[12:14]  # 2 bytes

	# Remaining fields (Big Endian)
	data4 = hex_str[16:20]  # 2 bytes
	data5 = hex_str[20:]  # 6 bytes

	# Format GUID
	return f"{{{data1}-{data2}-{data3}-{data4}-{data5}}}"

shellguids = {
	"{20d04fe0-3aea-1069-a2d8-08002b30309d}": "My Computer/Computer/This PC",
	"{00020d75-0000-0000-c000-000000000046}": "Inbox (Outlook)",
	"{00020d76-0000-0000-c000-000000000046}": "Inbox",
	"{00021400-0000-0000-c000-000000000046}": "Desktop",
	"{00028b00-0000-0000-c000-000000000046}": "History",
	...
	"{09f581a3-1f64-4e5b-8db3-88f5593080cc}": "Unknown",
	"{0afaced1-e828-11d1-9187-b532f1e9575d}": "Folder Shortcut",
	"{0bd8e793-d371-11d1-b0b5-0060972919d7}": "SolidWorks Enterprise PDM",
	"{0c39a5cf-1a7a-40c8-ba74-8900e6df5fcd}": "Unknown",
	"{0cd7a5c0-9f37-11ce-ae65-08002b2e1262}": "Cabinet File/Cabinet Shell Folder",
	"{0db7e03f-fc29-4dc6-9020-ff41b59e513a}": "3D Objects",
	"{0df44eaa-ff21-4412-828e-260a8728e7f1}": "Taskbar and Start Menu/Taskbar",
	...
	"{1bef2128-2f96-4500-ba7c-098dc0049cb2}": "Unknown",
	...
	"{1f4de370-d627-11d1-ba4f-00a0c91eedba}": "Computer Search Results Folder/Search Results - Computers",
	...
	"{21ec2020-3aea-1069-a2dd-08002b30309d}": "All Control Panel Items/Control Panel",
	...
	"{2559a1f6-21d7-11d4-bdaf-00c04f60b9f0}": "Unknown",
	"{2559a1f7-21d7-11d4-bdaf-00c04f60b9f0}": "Set Program Access and Defaults",
	"{2559a1f8-21d7-11d4-bdaf-00c04f60b9f0}": "Search (Modern)",
	...
	"{3134ef9c-6b18-4996-ad04-ed5912e00eb5}": "Unknown",
	"{323ca680-c24d-4099-b94d-446dd2d7249e}": "Favorites/Common Places",
	...
	"{38a98528-6cbf-4ca9-8dc0-b1e1d10f7b1b}": "Connected To",
	"{3936e9e4-d92c-4eee-a85a-bc16d5ea0819}": "Frequent Places Folder",
	"{3add1653-eb32-4cb0-bbd7-dfa0abb5acca}": "Pictures",
	"{3c5c43a3-9ce9-4a9b-9699-2ac0cf6cc4bf}": "@xpsp2res.dll,-16201",
	"{3dc7a020-0acd-11cf-a9bb-00aa004ae837}": "History",
	"{3dfdf296-dbec-4fb4-81d1-6a3438bcf4de}": "Music",
	"{3f6bc534-dfa1-4ab4-ae54-ef25a74e0107}": "System Restore",
	"{4026492f-2f69-46b8-b9bf-5654fc07e423}": "Windows Firewall/Windows Defender Firewall",
	...
	"{52205fd8-5dfb-447d-801a-d0b52f2e83e1}": "File Explorer",
	"{5399e694-6ce5-4d6c-8fce-1d8870fdcba0}": "Control Panel command object for Start menu and desktop",
	"{58e3c745-d971-4081-9034-86e34b30836a}": "Speech Recognition/Speech Recognition Options",
	"{59031a47-3f72-44a7-89c5-5595fe6b30ee}": "Shared Documents Folder/UsersFiles",
	...
	"{64693913-1c21-4f30-a98f-4e52906d3b56}": "Unknown",
	...
	"{7007acc7-3202-11d1-aad2-00805fc1270e}": "Network and Dial-up Connections/Network Connections",
	...
	"{7a9d77bd-5403-11d2-8785-2e0420524153}": "Users and Passwords/User Accounts",
	...
	"{98f275b4-4fff-11e0-89e2-7b86dfd72085}": "Unknown",
	"{992cffa0-f557-101a-88ec-00dd010ccc48}": "Network and Dial-up Connections/Network Connections",
	...
	"{a00ee528-ebd9-48b8-944a-8942113d46ac}": "Unknown",
	...
	"{b98a2bea-7d42-4558-8bd1-832f41bac6fd}": "Backup And Restore/Windows 7 File Recovery",
	"{bb06c0e4-d293-4f75-8a90-cb05b6477eee}": "System",
	"{bb64f8a7-bee7-4e1a-ab8d-7d8273f7fdb6}": "Security and Maintenance CPL/Action Center CPL",
	...
	"{bd7a2e7b-21cb-41b2-a086-b309680c6b7e}": "Offline Files",
	...
	"{d20ea4e1-3957-11d2-a40b-0c5020524153}": "Administrative Tools/Windows Tools",
	...
	"{daf95313-e44d-46af-be1b-cbacea2c3065}": "Unknown",
	"{dfd52831-23a3-2823-0400-000000001f28}": "Unknown",
	"{dffacdc5-679f-4156-8947-c5c76bc0b67f}": "delegate folder that appears in Users Files Folder",
	"{e17d4fc0-5564-11d1-83f2-00a0c90dc849}": "Search Results/Search Results Folder",
	"{e211b736-43fd-11d1-9efb-0000f8757fcd}": "Scanners & Cameras",
	"{e345f35f-9397-435c-8f95-4e922c26259e}": "Unknown",
	"{e413d040-6788-4c22-957e-175d1c513a34}": "Sync Center Conflict Delegate Folder",
	"{e44e5d18-0652-4508-a4e2-8a090067bcb0}": "Default Programs/Default Apps",
	...
	"{ed228fdf-9ea8-4870-83b1-96b02cfe0d52}": "Games Explorer/@C:\Windows\System32\shell32.dll,-30579",
	"{ed50fc29-b964-48a9-afb3-15ebb9b97f36}": "Printhood delegate folder",
	"{ed7ba470-8e54-465e-825c-99712043e01c}": "All Tasks",
	"{ed834ed6-4b5a-4bfe-8f11-a626dcb6a921}": "Personalization Control Panel/Personalization CPL Provider",
	...
	"{f874310e-b6b7-47dc-bc84-b9e6b38f5903}": "Unknown",
	...
	"{fbeb8a05-beee-4442-804e-409d6c4515e9}": "Unknown",
